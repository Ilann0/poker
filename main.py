...
general_label = tkinter.Label(
    stats_frame, text='General Stats:', font='Helvetica 12 bold')
...
win_stats_tree_view.grid(column=0, row=0, columnspan=2)
general_label.grid(column=0, row=4, rowspan=4, columnspan=2, sticky='w')
general_stats_tree_view.grid(column=0, row=8, columnspan=2)
run_stats_button.grid(column=0, row=9)
